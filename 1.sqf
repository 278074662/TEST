hostname        					= "exilemod.com (1.0.4|1.80)";
password         					= "";
...
BattlEye            				= 1;
requiredBuild 						= 146773; // 1.80 stable
...
class Missions
{
	class Exile
	{
		template = Exile.ChernarusRedux;  // Exile.Namalsk, Exile.Altis, Exile.Tanoa, ExileEscape.Altis, ExileEscape.Tanoa
