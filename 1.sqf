...
EZM_MinSpawnDistance				= 50;               // Closest distance from any player to spawn a zombie.
...
EZM_ExplosiveZombiesRatio			= 10;                // percentage of explosive zombies
EZM_ExplosiveZombieWarning			= "需要帮助群里联系panda !!!";// Message that will display a few seconds before the explosion of a zombie.
...
EZM_ZombieMaxMoney					= 30;               // Max Money per zombie kill-random amount put on corpses
...
EZM_ryanzombiesattackdistance				= 1;		// Attack distance, *(in meters)
...
EZM_ryanzombiescanthrow						= 0;		// Enable or disable Throwing for zombies
...
EZM_HarassingZedChance						= 30;		// Percent chance per player for a harassing Zed to spawn on them
