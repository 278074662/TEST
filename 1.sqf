if(isServer) then {
	...
	/* GENERAL CONFIG */
		...
		blacklist				= [
			[[0,16000,0],[500,-0,0]],				// Left
			[[0,16000,0],[16000.0,15000.3,0]]			// Top
		];
	...
	/* AI CONFIG */
		...
		ai_moneyAmount				= 5000;			//If ai_hasMoney=true, this defines what's the max amount of money an AI can hold,
		...
		ai_static_array				= [["aimingAccuracy",0.20],["aimingShake",0.70],["aimingSpeed",0.75],["endurance",1.00],["spotDistance",0.50],["spotTime",0.50],["courage",1.00],["reloadSpeed",1.00],["commanding",1.00],["general",1.00]];
		...
		ai_wep_owlmg				= ["vil_RPK75_Romania","vil_M240_B","vil_M249_Para","skavil_M60","skavil_M60e3","vil_Mg3","vil_MG4","vil_MG4E","vil_PKP","vil_PKP_EOT","vil_PK","vil_PKM","vil_RPD","vil_RPK","vil_RPK75","vil_RPK75_M72","vil_zastava_m84"];	// Overwatch LMG Variants
		...
		ai_wep_assault				= ["M16A4_ACOG_DZ","Sa58V_RCO_EP1","M8_sharpshooter","M4A1_HWS_GL_camo","M4A3_CCO_EP1","M4A3_CCO_EP1","M4A1_AIM_SD_camo","M16A4","m8_carbine","Sa58V_CCO_EP1"];	// Assault
		ai_wep_machine				= ["Mk48_CCO_DZ","M249_DZ","Pecheneg_DZ","M240_DZ"];	// Light machine guns
	...
	/* WAI MISSIONS CONFIG */
		...
		wai_avoid_missions			= 1050;								// avoid spawning missions this close to other missions, these are defined in wai_mission_markers
		...
		wai_mission_timer			= [3,30];							// time between missions 5-15 minutes
		...
		// Vehicle arrays
		armed_vehicle 				= ["ArmoredSUV_PMC_DZE","M113_TK_EP1","HMMWV_M1151_M2_CZ_DES_EP1_DZE","BTR90_HQ","BAF_Jackal2_L2A1_W","BAF_Jackal2_GMG_W","BTR40_MG_TK_INS_EP1","LandRover_SPG9_TK_EP1","HMMWV_mk19","LAV25_HQ"];
		armed_chopper 				= ["CH_47F_EP1_DZ","UH1H_DZ","Mi17_DZ","UH60M_EP1_DZ","UH1Y_DZ","pook_H13_gunship","Mi171Sh_CZ_EP1","CYBP_Camel_rus","CYBP_Camel_us"];
		civil_chopper 				= ["BAF_Merlin_DZE","AH6J_EP1_DZ","Mi17_Civilian_DZ"];
		...
		crate_items				= ["ItemRuby","ItemCitrine","ItemEmerald","ItemAmethyst","ItemSapphire","ItemObsidian","ItemTopaz","FoodNutmix","FoodPistachio","FoodMRE","ItemSodaOrangeSherbet","ItemSodaRbull","ItemSodaR4z0r","ItemSodaMdew","ItemSodaPepsi","ItemBandage","ItemSodaCoke","FoodbaconCooked","FoodCanBakedBeans","FoodCanFrankBeans","FoodCanPasta","FoodCanSardines","FoodchickenCooked","FoodmuttonCooked","FoodrabbitCooked","FishCookedTrout","FishCookedTuna","FishCookedSeaBass","ItemAntibiotic",
		"ItemBloodbag","ItemEpinephrine","ItemHeatPack","ItemMorphine","ItemGoldBar","ItemGoldBar10oz","CinderBlocks","ItemCanvas","ItemComboLock","ItemLightBulb","ItemLockbox","ItemSandbag","ItemTankTrap","ItemWire","MortarBucket","PartEngine","PartFueltank","PartGeneric","PartGlass","PartPlankPack","PartVRotor","PartWheel","PartWoodPile"];
		crate_items_high_value			= ["ItemBriefcase_base","ItemBriefcase100oz","ItemVault","plot_pole_kit","ItemHotwireKit","ItemRuby","ItemCitrine","ItemEmerald","ItemAmethyst","ItemSapphire","ItemObsidian","ItemTopaz"];
		...
		crate_items_buildables			= ["forest_large_net_kit","cinder_garage_kit",["PartPlywoodPack",5],"ItemSandbagExLarge5X","park_bench_kit","ItemComboLock",["CinderBlocks",40],"ItemCanvas","ItemComboLock",["ItemVault",2],"ItemLockbox",["ItemSandbag",10],["full_cinder_wall_kit",5],["half_cinder_wall_kit",10],["MortarBucket",20],["PartPlankPack",5],"PartWoodPile"];
		...
		crate_weapons				= ["vil_HK417s","vil_M110","vil_M110sd","RH_m14","vil_M14G","RH_m14acog","RH_m14aim","RH_m14eot","RH_m1s","RH_m1sacog","RH_m1saim","RH_m1seot","RH_m1sshd","RH_m1ssp","RH_m1st","RH_m1stacog","RH_m1staim",
		"RH_m1steot","RH_m1stshd","RH_m1stsp","RH_m21","vil_M21G","RH_sc2","RH_sc2acog","RH_sc2aim","RH_sc2eot","RH_sc2shd","RH_sc2sp","vil_SR25","vil_SR25SD","RH_hk417","RH_hk417acog","RH_hk417aim","RH_hk417s","RH_hk417sacog","RH_hk417saim","RH_hk417seotech",
		"RH_hk417eotech","RH_hk417sd","RH_hk417sdacog","RH_hk417sdaim","RH_hk417sdeotech","RH_hk417sdsp","RH_hk417sp","RH_hk417sglacog","RH_hk417sgl","RH_hk417sglaim","RH_hk417sgleotech","vil_RPK75_Romania","vil_M240_B","vil_M249_Para","skavil_M60","skavil_M60e3",
		"vil_Mg3","vil_MG4","vil_MG4E","vil_PKP","vil_PKP_EOT","vil_PK","vil_PKM","vil_RPD","vil_RPK","vil_RPK75","vil_RPK75_M72","vil_zastava_m84","vil_AG3","vil_G3a2","vil_G3a3","vil_G3an","vil_G3anb","vil_G3SG1","vil_G3sg1b",
		"vil_G3TGS","vil_G3TGSb","vil_G3ZF","vil_G3zfb","vil_G3a4","vil_G3a4b","USSR_cheytacM200","USSR_cheytacM200_sd","vil_SVD_63","vil_SVD_N","vil_SVD_M","vil_SVD_P21","vil_SVD_S","gms_k98","gms_k98_knife","gms_k98_rg","gms_k98zf39","FHQ_MSR_DESERT","FHQ_MSR_NV_DESERT",
		"FHQ_MSR_NV_SD_DESERT","FHQ_MSR_SD_DESERT","FHQ_RSASS_TAN","FHQ_RSASS_SD_TAN","vil_SV_98_69","vil_SV_98","vil_SV_98_SD","vil_SVDK","FHQ_XM2010_DESERT","FHQ_XM2010_NV_DESERT","FHQ_XM2010_NV_SD_DESERT","FHQ_XM2010_SD_DESERT","SCAR_L_CQC_CCO_SD","SCAR_L_CQC","SCAR_L_CQC_Holo",
		"SCAR_L_CQC_EGLM_Holo","SCAR_L_STD_EGLM_RCO","SCAR_L_STD_HOLO","SCAR_L_STD_Mk4CQT","SCAR_H_CQC_CCO","SCAR_H_CQC_CCO_SD","SCAR_H_STD_EGLM_Spect","SCAR_H_LNG_Sniper","SCAR_H_LNG_Sniper_SD","M14_CCO_DZ","M110_NVG_EP1","SVD_Gh_DZ","VSS_Vintorez","DMR_DZ","M40A3_Gh_DZ"];
